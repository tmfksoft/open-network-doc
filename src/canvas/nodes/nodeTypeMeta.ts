...
import type { ButtonLinkType } from '../../fileformat/types'
...
export const BUTTON_ICON = IconClick
...
export const BUTTON_LINK_TYPE_LABELS: Record<ButtonLinkType, string> = {
  website: 'Website',
  sheet: 'Sheet',
  kb_article: 'KB Article',
}

export const BUTTON_LINK_TYPE_ICONS: Record<ButtonLinkType, typeof IconWorld> = {
  website: IconExternalLink,
  sheet: IconDoorEnter,
  kb_article: IconFileText,
}
